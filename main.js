...
submit.addEventListener('click', () => {
    ...
    if(answer){
        ...
        if(currentQuiz < quizData.length){
            ...
            if(scoreart >= 4 && 1 <= scoredav <= 3 && 1 <= scoregum <= 3){
            ...
            if(scoredav >= 4 && 1 <= scoreart <= 3 && 1 <= scoregum <= 3){
            ...
            if(scoregum >= 4 && 1 <= scoreart <= 3 && 1 <= scoredav <= 3){
            ...
            if(scoredav <= 4 && scoregum <= 4 && scoreart <= 4){
